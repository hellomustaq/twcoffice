...
<nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        <a href="{{ route('index') }}">
{{--                            <img style="max-height:60px;" src="{{ asset($footer->footer_img) }}" alt="homepage" class="dark-logo">--}}
                            <img src="{{ asset($settings->header_img) }}" alt="BD SOFT IT" style="max-width: 175px;">
                        </a>
{{--                        <a href="#">--}}
{{--                            <img src="{{ asset('images/logo.jpg') }}" alt="BD SOFT IT" style="max-width: 175px;">--}}
{{--                        </a>--}}
                    ...
                    <div class="navbar-container container-fluid">
                        <ul class="nav-left">
                            <h3 class="px-3 py-3" style="padding-left: 24rem !important; text-align: center">{{ $settings->header_title }}</h3>
                            ...
                            <li class="user-profile header-notification">
                                ...
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        @if(Auth::user()->image !== null && strlen(Auth::user()->image) > 5)
                                            <img src="{{ imageCache(Auth::user()->image, '80') }}" class="img-radius" alt="User-Profile-Image">
                                        @else
