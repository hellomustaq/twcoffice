                ...
                <div class="row">
                    <div class="col-md-12" align="center">
                        ...
                        <h6>
                            ...
                            <span style="color: red;">{{ '( ' . $itemLogs->sum('il_cost') . ' TK)' }}</span>
                        </h6>
                        <h6>
{{--                            Total Transferred: {{ $itemTransferLogs->sum('il_quantity') }}--}}
{{--                            <span style="color: red;">{{ '( -' . $itemTransferLogs->sum('il_cost') . ' TK)' }}</span>--}}
                        </h6>
                        <h6>Current Quantity: {{ $itemLogs->sum('il_quantity')  }}</h6>
                        <h5 style="color: red;">Cost : {{ $itemLogs->sum('il_cost')  }} TK</h5>
                    </div>
                </div>
            </div>
...
{{--                            <th scope="col">By</th>--}}
                        ...
                        <tbody>
                        @foreach($itemLogInfo as $index => $log)
                            <tr>
